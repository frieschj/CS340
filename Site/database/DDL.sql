...
CREATE OR REPLACE TABLE ParkSystems (
    ...
    PRIMARY KEY (parkID),
    FOREIGN KEY (parkPassID) REFERENCES ParkPasses(parkPassID)
);
...
CREATE OR REPLACE TABLE Trails (
    ...
    PRIMARY KEY (trailID),
    FOREIGN KEY (parkID) REFERENCES ParkSystems(parkID),
    FOREIGN KEY (difficultyID) REFERENCES TrailDifficulties(difficultyID)
);
